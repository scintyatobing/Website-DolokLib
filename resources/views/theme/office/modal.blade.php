...
<div class="modal fade" id="userBorrowModal" tabindex="-1" role="dialog" aria-labelledby="userBorrowModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="contentUserBorrowModall">
...
<div class="modal fade" id="borrowModal" tabindex="-1" role="dialog" aria-labelledby="borrowModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="contentBorrowModal">
