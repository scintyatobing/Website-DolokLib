...
<div id="content_list">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <a href="javascript:void(0);" onclick="load_input('<?php echo e(route('office.borrow.create')); ?>')" class="btn btn-outline-primary mb-3 btn-icon-split btn-sm" >
                    <span class="icon text-white-50">
...
<?php endif; ?><?php /**PATH D:\KULIAH\DICODING\laragon\www\perpustakaan\resources\views/pages/office/borrow/main.blade.php ENDPATH**/ ?>