<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item <?php echo e(request()->is('office/dashboard') ? 'active' : ''); ?>">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            ...
            <a class="collapse-item <?php echo e(request()->is('office/member') ? 'active' : ''); ?>" href="<?php echo e(route('office.member.index')); ?>">Data Member</a>
            <a class="collapse-item <?php echo e(request()->is('office/employee') ? 'active' : ''); ?>" href="<?php echo e(route('office.employee.index')); ?>">Data Karyawan</a>
        ...
        <li class="nav-item <?php echo e((request()->is('office/book-category') || request()->is('office/all-cat')) ? 'active' : ''); ?>">
        ...
        <!-- Nav Item - Charts -->
        <li class="nav-item <?php echo e(request()->is('office/borrow/index') ? ' active' : ''); ?>">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <!-- End of Topbar --><?php /**PATH C:\laragon\www\perpustakaan-l8-h\resources\views/theme/office/aside.blade.php ENDPATH**/ ?>